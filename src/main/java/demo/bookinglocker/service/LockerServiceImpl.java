...
public class LockerServiceImpl implements LockerService{
    ...
    public Locker updateAfterPassAttempt0(int lockerNumber) {
        ...
        lockerUpdatePassAttempt0.setpassPasswordAttempts(2);
    ...
    @Override
    public Locker setPassword(int lockerNumber) {
        Locker LockersetPassword = lockerRepository.findLockerByLockerNumber(lockerNumber);
        String password = RandomPasswordGenerator.generateRandomPassword();
        LockersetPassword.setPassword(password);
        return lockerRepository.save(LockersetPassword);
